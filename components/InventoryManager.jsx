      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-600 font-medium">
            Управление запасами и ресурсами предприятия
          </p>
        </div>
      ...
      <div className="glass-panel rounded-[2.5rem] border border-slate-200 overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-slate-100">
            <tr>
              <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-600 tracking-widest">
                Наименование
              </th>
              <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-600 tracking-widest">
                Категория
              </th>
              <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-600 tracking-widest text-center">
                Остаток
              </th>
              <th className="px-8 py-5 text-[10px] font-black uppercase text-slate-600 tracking-widest">
                Стоимость
            ...
            {inventory.length > 0 ? (
              inventory.map((item) => (
                ...
                >
                  ...
                  <td className="px-8 py-6 text-[10px] font-black text-slate-600 uppercase tracking-widest">
                    {item.category}
                  </td>
                  <td className="px-8 py-6 text-center">
                    <span
                      className={`font-black px-3 py-1 rounded-lg ${item.stock < 5 ? "bg-rose-500/20 text-rose-500 animate-pulse" : "bg-orange-500/10 text-orange-600"}`}
                    >
                      {item.stock}
                    </span>
                  </td>
