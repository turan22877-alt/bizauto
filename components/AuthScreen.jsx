      ...
      <div className="w-full max-w-[480px] mx-auto relative z-20 px-8">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-black shadow-xl mb-6">
            <span className="header-font text-3xl font-black text-orange-500">
              S
            </span>
          </div>
          <h1 className="header-font text-5xl font-black text-stone-900 tracking-tighter mb-3">
            Selliz
          </h1>
        ...
        <div className="glass-panel rounded-[2rem] border border-slate-200 p-12 shadow-2xl w-full">
          ...
          <form onSubmit={submit} className="space-y-8">
            ...
            <Button
              type="submit"
              className="w-full py-5 mt-4 text-base bg-black hover:bg-stone-900"
              loading={loading}
            >
