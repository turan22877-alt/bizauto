      ...
      items: [
        {
          ...
          badge: pendingAppointmentsCount || undefined,
        },
        {
          id: AppSection.BOOKING_JOURNAL,
        ...
        <div className="flex flex-col h-full min-h-0 p-5">
            ...
            >
              ...
              {!collapsed && (
                <div className="flex flex-col min-w-0 overflow-hidden">
                  <h1 className="header-font text-sm font-black text-white tracking-tight truncate">
                    SELLIZ
                  </h1>
          ...
          <button
            ...
            className={`mb-4 rounded-lg border border-stone-700 text-stone-400 hover:text-white hover:bg-stone-800 transition-all hidden lg:flex ${
              collapsed
                ? "mx-auto w-10 h-10 items-center justify-center"
                : "w-full items-center justify-end p-2"
            }`}
          ...
          {/* Status footer */}
          <div
            className={`mt-4 pt-4 border-t border-stone-800 shrink-0 ${collapsed ? "flex justify-center" : ""}`}
          >
            {collapsed ? (
